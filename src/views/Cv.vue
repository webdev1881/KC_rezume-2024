    ...
    <div class="header">
      <div class="container">
        <div class="header--content">
          <div class="name">
            <div class="title">
              {{ "lastname" | localize }} {{ "firstname" | localize }}
            </div>
            <div class="posada">
              {{ "posada" | localize }}
            </div>
          ...
          <div class="info">
            ...
            <div class="cont">
              <div class="contact">{{ " https://t.me/Vlad_Lit1991 " }}</div>
              <div class="contact">{{ "vladimirsky1991@gmail.com" }}</div>
              <div class="contact2">{{ " https://t.me/Vlad_Lit1991 &nbsp | &nbsp vladimirsky1991@gmail.com" }}</div>
            </div>
          </div>
    ...
    <div class="main">
      <div class="container">
        <div class="wrap">
          ...
          <div class="block">
            <div class="title">
              <div class="name">{{ "skills" | localize }}</div>
              <div class="line"></div>
            </div>
            ...
            <div class="skills">
              ...
              <div class="skil">
                <li class="nam">{{ "7" | localize }}</li>
                <div class="val">Gitlab, Git</div>
              </div>
              <div class="skil">
              ...
              <div class="skil">
                ...
                <div class="val">Chart.js, Three.js</div>
              </div>
            </div>
          </div>
          ...
          <div class="block">
            <div class="title">
              <div class="name">{{ "exp" | localize }}</div>
              <div class="line"></div>
            </div>
            ...
            <div class="job-details">{{ "job2" | localize }}</div>
            <li class="jb">{{ "job2222" | localize }}</li>
          ...
          <div class="block">
            <div class="title">
              <div class="name">{{ "add" | localize }}</div>
              <div class="line"></div>
            </div>
            ...
            <div class="experiance">
              ...
              <div class="ex2">
                <div class="ex_item">- {{ "add6" | localize }}</div>
          ...
          <div class="block port">
            <div class="title">
              <div class="social">
                <a href="https://t.me/Vlad_Lit1991" target="_blank"><div class="item tel"></div></a>
...
export default {
  ...
  async mounted() {
    ...
    if ( this.$route.name === "ru" ) {
      this.locate = "ru"
      this.$store.dispatch("CHANGE_LANGUAGE", "ru");
    }
